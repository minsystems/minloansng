...
class Borrower(models.Model):
    ...
    mono_code = models.CharField(blank=True, null=True, max_length=500)
    ...
    working_status = models.CharField(max_length=500, choices=WORKING_STATUS, blank=True, null=True)
    ...
    bvn = models.CharField(blank=True, null=True, max_length=500, help_text='Bank Verification Number')
